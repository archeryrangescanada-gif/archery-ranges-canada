...
CSV_FILE = 'new_brunswick_archery_ranges_enriched.csv'
OUTPUT_DIR = 'public/new_brunswick_listing_images'
MAPPING_FILE = 'new_brunswick_images_mapping.csv'
            ...
            for name, url in ranges:
                ...
                if best_image:
                    ...
                    if success:
                        ...
                        downloaded.append((name, f"/new_brunswick_listing_images/{filename}"))
                    else:
                        failed.append(name)
                else:
