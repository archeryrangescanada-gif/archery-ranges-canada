...
CSV_FILE = 'nwt_archery_ranges_enriched.csv'
OUTPUT_DIR = 'public/nwt_listing_images'
MAPPING_FILE = 'nwt_images_mapping.csv'
            ...
            for name, url in ranges:
                ...
                if best_image:
                    ...
                    if success:
                        ...
                        downloaded.append((name, f"/nwt_listing_images/{filename}"))
                    else:
                        failed.append(name)
                else:
