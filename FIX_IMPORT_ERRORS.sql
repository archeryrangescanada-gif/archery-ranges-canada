-- =====================================================
-- FIX BC RANGES IMPORT ERRORS
-- =====================================================
-- Run this in Supabase SQL Editor to fix the import issues

-- Step 1: Check current ranges table structure
...
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS range_length_yards INTEGER;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS number_of_lanes INTEGER;
...
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS membership_price_adult NUMERIC;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS drop_in_price NUMERIC;
...
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS accessibility BOOLEAN DEFAULT false;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS parking_available BOOLEAN DEFAULT false;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'active';
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS views_count INTEGER DEFAULT 0;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS is_premium BOOLEAN DEFAULT false;
ALTER TABLE ranges ADD COLUMN IF NOT EXISTS is_claimed BOOLEAN DEFAULT false;

-- Step 3: Make city_id and province_id nullable temporarily for import
...
-- Step 4: Create or replace the import function with better error handling
